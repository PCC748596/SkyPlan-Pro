...
export const TwoDayTimelineModal: React.FC<TwoDayTimelineModalProps> = ({
  ...
  const getStyleProps = (assignment: Assignment) => {
    ...
    if (activities) {
      const byCode = activities.find(a => a.code === assignment.details || a.code === assignment.type || a.code === assignment.code);
  ...
  return (
    <div className="absolute inset-0 z-50 bg-slate-950/95 backdrop-blur-md flex flex-col justify-between overflow-hidden animate-in fade-in duration-200">
                  ...
                  <div className="flex flex-1 relative min-w-[1000px]">
                    ...
                    >
                      ...
                      {day1Assignments.map((ass) => {
                        const styleProps = getStyleProps(ass);
                        ...
                        return (
                          <div
                            ...
                            className={`
                              ...
                              border hover:scale-[1.02] hover:z-20 overflow-hidden
                              ${styleProps.className}
                            `}
                            style={{ left: pos.left, width: pos.width, ...styleProps.style }}
                          >
                            {isFlight ? (
      ...
      {hoveredAssignment && (
        <div 
          className="fixed z-[550] bg-slate-900 border border-slate-700 p-2.5 rounded-lg shadow-2xl text-xs max-w-xs pointer-events-none"
